<?php namespace Jbn\Cart\Storage;
/**
 * Class LaravelCache
...
use Jbn\Cart\Item;
use Jbn\Cart\Storage;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache as LaravelCacheStorage;

class LaravelCache implements \Jbn\Cart\StorageInterface
{
    private $cachePrefix;
    ...
    {
        $this->cachePrefix = Config::get('Jbncart.cache_prefix', 'session');
    }
    ...
    protected function saveCart()
    {
        ...
        $expires = Config::get('Jbncart.cache_expire', 60);
